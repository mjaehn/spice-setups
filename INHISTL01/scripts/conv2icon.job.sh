...
# Convert from 365 days calendar to proleptic_gregorian calendar
${NCO_BINDIR}/ncatted -O -a calendar,time,o,c,"proleptic_gregorian" ${OUTDIR}/${YYYY_MM}/LOWBC_${YYYY}_${MM}.nc

# Check and fix the last time value in LOWBC file if necessary
${PYTHON} ${PFDIR}/${EXPID}/scripts/fix_time_last.py ${OUTDIR}/${YYYY_MM}/LOWBC_${YYYY}_${MM}.nc
